...
Personal portfolio site for Mirazul Haq Srabon — Sr. Product Design Manager at Docusign.

Built with Astro, Tailwind CSS, and Claude Code. Hosted on Vercel. Zero monthly hosting costs.

**[→ View the live site](https://mirazulhaqsrabon.vercel.app)**
...
```bash
# Clone the repo
git clone https://github.com/mirazulhaqsrabon/mirazul haq srabon-portfolio.git
cd mirazul haq srabon-portfolio
...
See the full design system at [jonathanruiz.net/styleguide](https://mirazulhaqsrabon.vercel.app/styleguide).
...
**Mirazul Haq Srabon** is a Husband, Father of two, Sr. Product Design Manager at Docusign and co-leader of Friends of Figma Miami.

This site was designed and built using Claude Code.

- **Portfolio:** [jonathanruiz.net](https://mirazulhaqsrabon.vercel.app)
- **LinkedIn:** [linkedin.com/in/mirazulhaqsrabon](https://linkedin.com/in/mirazulhaqsrabon)
